...
var config      = require("browser-sync-ui/lib/config");
var eachSeries  = require("async-each-series");
var asyncTasks  = require("browser-sync-ui/lib/async-tasks");
var hooks       = require("browser-sync-ui/lib/hooks");
var merge       = require("browser-sync-ui/lib/opts").merge;

var defaultPlugins = {
    "sync-options":     require("browser-sync-ui/lib/plugins/sync-options/sync-options.plugin"),
    "overview":         require("browser-sync-ui/lib/plugins/overview/overview.plugin"),
    "history":          require("browser-sync-ui/lib/plugins/history/history.plugin"),
    "plugins":          require("browser-sync-ui/lib/plugins/plugins/plugins.plugin"),
    "remote-debug":     require("browser-sync-ui/lib/plugins/remote-debug/remote-debug.plugin"),
    "help":             require("browser-sync-ui/lib/plugins/help/help.plugin"),
    "connections":      require("browser-sync-ui/lib/plugins/connections/connections.plugin"),
    "network-throttle": require("browser-sync-ui/lib/plugins/network-throttle/network-throttle.plugin")
};
...
var UI = function (opts, bs, emitter) {
     ...
     * @type {*}
     */
    ui.bsPlugins = require("browser-sync-ui/lib/resolve-plugins")(bs.getUserPlugins());
